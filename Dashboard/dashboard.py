...
def workingday_holiday_page():
    ...
    sns.barplot(
        ...
        y='cnt',
        hue='holiday' if selected_category == 'workingday dan holiday' else None,
        palette='Set2',
        ax=ax
    )
...
def landing_page():
    ...
    if st.button('Pengguna Sepeda berdasarkan Workingday dan Holiday'):
        st.session_state.page = 'workingday_holiday'
    elif st.button('Pengguna Sepeda berdasarkan Cuaca'):
